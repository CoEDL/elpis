...
from elpis.engines.hftransformers.objects.transcription import HFTransformersTranscription
...
class HFTransformersEngine(Engine):
    def __init__(self):
        super().__init__(HFTransformersModel, HFTransformersTranscription)
