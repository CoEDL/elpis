...
#     """
#     print("**** transformer clean_utterance")
#     # TODO interface setting for user to add/edit tags
#     translation_tags = {"@eng@", "<ind:", "<eng:"}
#     # TODO interface setting to make this optional
...
# replace this with elpis/engines/common/input/clean_json.py clean_json_data()
